...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run the curated AgentCoder overfit sanity gate end to end.")
    parser.add_argument("--data", default="examples/agentcoder_overfit_sanity.jsonl")
    parser.add_argument("--config", default="configs/scratch/raam_agentcoder_overfit.yaml")
    parser.add_argument("--output-dir", default="runs/agentcoder_overfit_sanity")
    ...
    eval_json = output_dir / "overfit_eval.json"
